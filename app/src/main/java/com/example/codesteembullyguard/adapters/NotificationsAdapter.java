...
import com.example.codesteembullyguard.viewholders.MyViewHolder;
...
public class NotificationsAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public NotificationsAdapter(Context context, List<NotificationsModel> items) {
    ...
    public void onBindViewHolder(@NonNull  MyViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(ApiClient.BASE_URL+"/files/"+items.get(position).getChildUserImage())
